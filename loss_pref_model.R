...
model_slurm <- function(neg_costs, n_moves){model(pop_size = pop_size, t = t, neg_cost = neg_costs, n_moves = n_moves, delta = 1, networked = TRUE, loss_averse = TRUE, pref_payoff = TRUE)}

#run simulations
rslurm::slurm_apply(model_slurm, params, jobname = "loss_pref_model",
