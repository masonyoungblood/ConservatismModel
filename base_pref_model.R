...
model_slurm <- function(neg_costs, n_moves){model(pop_size = pop_size, t = t, neg_cost = neg_costs, n_moves = n_moves, delta = 0, networked = TRUE, pref_payoff = TRUE)}

#run simulations
rslurm::slurm_apply(model_slurm, params, jobname = "base_pref_model",
