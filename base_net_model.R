...
model_slurm <- function(neg_costs, n_moves){
  model(pop_size = 5000, t = 100, priors = c(5, 0, 0, 0), neg_cost = neg_costs, n_moves = n_moves, phi = 0.5, delta = 0, kappa = 0, lambda = 1, networked = TRUE)
}

#run simulations
rslurm::slurm_apply(model_slurm, params, jobname = "base_net_model",
